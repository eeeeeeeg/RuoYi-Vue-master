<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="站点坐标" prop="coordinates">
        <el-input
    ...
    >
      ...
      <el-table-column label="站点坐标" align="center" prop="coordinates" />
      <el-table-column label="站点状态" align="center" prop="status">
        <template slot-scope="scope">
          <el-tag class="ml-2" type="success" v-if="scope.row.status == '01'"
            >正常</el-tag
          >
          <el-tag class="ml-2" type="danger" v-else>作废</el-tag>
        </template>
      </el-table-column>
    ...
    >
      <div class="dialog-container">
        ...
        >
          ...
          <el-form-item label="站点坐标" prop="coordinates">
            <el-input v-model="form.coordinates" placeholder="请输入站点坐标" />
          </el-form-item>
          <el-form-item label="站点状态" prop="status">
            <el-radio v-model="form.status" label="01">正常</el-radio>
            <el-radio v-model="form.status" label="02">作废</el-radio>
          </el-form-item>
        </el-form>
      </div>
...
import DistanceViewer from "./dialog/DistanceViewer.vue";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listSite(this.addDateRange(this.queryParams, this.createDateRange)).then(
        (response) => {
